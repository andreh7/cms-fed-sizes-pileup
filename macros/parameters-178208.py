...
# fitting range
linear_fit_min_per_bx_lumi = 4
linear_fit_max_per_bx_lumi = 5.7
...
# previously (as presented ? with an older JSON file ?)
# linear_fit_min_num_vertices = 25
# linear_fit_max_num_vertices = 35

linear_fit_min_num_vertices = 0
linear_fit_max_num_vertices = 43

# parameters for the corresponding plot
size_evolution_min_num_vertices = 0
size_evolution_max_num_vertices = max_num_vertices

size_evolution_rel_yscale = 1.5
