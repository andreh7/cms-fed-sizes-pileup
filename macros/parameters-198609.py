...
# fitting range
linear_fit_min_per_bx_lumi = 11.2
linear_fit_max_per_bx_lumi = 13.2
...
# original range
linear_fit_min_num_vertices,linear_fit_max_num_vertices  = 41, 53
...
if False:
    # plot by subsystem
    allSubsysToPlot = utils.getStandardSubsystemFEDnames() + [ 'total' ]
