...
# original range
linear_fit_min_num_vertices,linear_fit_max_num_vertices  = 5, 26
...
# allSubsysToPlot = fedgroups.makeAllFedsGroup(fedsInRun = fedsInRun)
