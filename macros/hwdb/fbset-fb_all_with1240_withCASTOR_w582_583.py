...
# generated with
#
# --eqset /daq2/eq_160913_01 listfbs --fbset /fb_all_with1240_withCASTOR_w582_583 --python
#
# FBSet /fb_all_with1240_withCASTOR_w582_583
fedBuilderGroups['fb_all_with1240_withCASTOR_w582_583'] = [
    { "name": "TCDS", "feds": [ 1024 ] },
    ...
    { "name": "CASTOR", "feds": [ 690, 691, 692, 693 ] },
    ...
    { "name": "BMTF", "feds": [ 1376, 1377 ] },

    { "name": "GMTGT", "feds": [ 1402, 1404 ] },

    { "name": "uTCAPixelPilot", "feds": [ 1240 ] },
    ...
    { "name": "CTPPS_TOT", "feds": [ 577, 578, 579, 580, 581, 582, 583 ] },
